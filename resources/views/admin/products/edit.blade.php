        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    {!! Form::model($product,['route' => ['admin.products.update',$product->id ], 'method'
                    =>'patch', 'files'=>true]) !!}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="image">Upload
                                                {{ Config::get('constants.PRODUCT_WIDTH',320).'x'.Config::get('constants.PRODUCT_HEIGHT',320) }}
                                                product image</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <div class="icheck-primary">
                                                    {!! Form::checkbox('take_fraction_qnt', '1', null,
                                                    ['id'=>'take_fraction_qnt',
                                                    'class'=>'form-control'])
                                                    !!}
                                                    {!! Form::label('take_fraction_qnt', '&nbsp;Take Fractional
                                                    Quantity') !!}
                                                </div>
                                            </div>
                                        </div>
