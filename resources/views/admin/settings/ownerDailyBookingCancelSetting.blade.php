...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-md-6">
                    <h1 class="m-0 text-dark">Owner Daily Booking Cancel Setting</h1>
                </div><!-- /.col -->
                <div class="col-md-6">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    {!! Form::model($setting,['route' => ['admin.ownerDailyBookingCancelStore',$setting->id], 'method' =>'patch'])
                    !!}
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title">Owner Daily Booking Cancel Setting Info</h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
