...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-md-6">
                    <h1 class="m-0 text-dark">Coupon Update</h1>
                </div><!-- /.col -->
                <div class="col-md-6">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    {!! Form::model($coupon,['route' => ['admin.coupons.update',$coupon->id ], 'method'
                    =>'patch', 'files'=>true]) !!}
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title">Edit Coupon Info</h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            {!! Form::text('valid_at', $coupon->valid_at ? $coupon->valid_at->format('Y-m-d') : null,
