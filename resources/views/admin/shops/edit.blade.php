...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-md-6">
                    <h1 class="m-0 text-dark">Shop Update</h1>
                </div><!-- /.col -->
                <div class="col-md-6">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    {!! Form::model($shop,['route' => ['admin.shops.update',$shop->id ],
                    'method' =>'patch', 'files'=>true]) !!}
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title">Edit Shop Info</h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="photo">Upload Shop {{ Config::get('constants.SHOP_WIDTH',1000).'x'.Config::get('constants.SHOP_HEIGHT',500) }} image</label>
                                        </div>
                                    </div>
